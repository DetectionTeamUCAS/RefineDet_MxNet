...
def parse_args():
    parser = argparse.ArgumentParser(description='Test with refineDet networks.')
    parser.add_argument('--network', type=str, default='refinedet_300_vgg16_atrous_voc',
    ...
    parser.add_argument('--data_shape', type=int, default=300,
...
if __name__ == '__main__':
    ...
    for image in image_list:
        x, img = presets.ssd.load_test(image, short=args.data_shape, max_size=args.data_shape)
        ...
        plt.savefig("res_" + image.split("/")[-1])
        # plt.show()
